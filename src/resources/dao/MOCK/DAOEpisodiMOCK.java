...
public class DAOEpisodiMOCK implements DAOEpisodi {
    ...
    public DAOEpisodiMOCK() {
        ...
        episodis_1.add(new Episodi("Breaking Bad: temporada 1", "BB: temporada 1: episodi 1"));
        episodis_1.add(new Episodi("Breaking Bad: temporada 1", "BB: temporada 1: episodi 2"));
        ...
        episodis_2.add(new Episodi("Breaking Bad: temporada 2", "BB: temporada 2: episodi 1"));
        episodis_2.add(new Episodi("Breaking Bad: temporada 2", "BB: temporada 2: episodi 2"));
        episodis_2.add(new Episodi("Breaking Bad: temporada 2", "BB: temporada 2: episodi 3"));
        ...
        episodis_3.add(new Episodi("Game of Thrones: temporada 1", "GoT: temporada 1: episodi 1"));
        episodis_3.add(new Episodi("Game of Thrones: temporada 1", "GoT: temporada 1: episodi 2"));
        ...
        episodis_4.add(new Episodi("Game of Thrones: temporada 2", "GoT: temporada 2: episodi 1"));
        episodis_4.add(new Episodi("Game of Thrones: temporada 2", "GoT: temporada 2: episodi 2"));
        episodis_4.add(new Episodi("Game of Thrones: temporada 2", "GoT: temporada 2: episodi 3"));
        ...
        episodis_4.add(new Episodi("Game of Thrones: temporada 3", "GoT: temporada 3: episodi 1"));
        episodis_4.add(new Episodi("Game of Thrones: temporada 3", "GoT: temporada 3: episodi 2"));
        episodis_4.add(new Episodi("Game of Thrones: temporada 3", "GoT: temporada 3: episodi 3"));
